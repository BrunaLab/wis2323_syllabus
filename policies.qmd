...
class_policies %>% 
 ...
 kbl(# digits = 2,
      ...
      # format="html",
      row.names = FALSE,
      escape= TRUE, # must be false for FA icons
      booktabs=T,
      #     bottomrule = F,
#     # toprule = F,
#     # midrule = F,
...
#  "./icons/check-wt.png" ,
#  "./icons/microphone-wt.png"
# ),100,100), width="3em",background="darkgreen", color="white", bold=T) %>% 
#   
column_spec(1, width = "10em",latex_valign = "m", color = "#1F691B",bold=T, background="white") %>%
  column_spec(2, width = "35em",latex_valign = "m", color = "black", background="white")
