...
Your assignment is to watch **two** films set in tropical rain forests, document the (often stereotypical) ways in which the rain forest setting is presented, and then summarize how this might shape the image of rain forests and rain forest people for viewers that are unfamiliar with these ecosystems. Complete details on how to complete these steps are below.

The assignment's value is **100 points** and it is due **October 3^rd^ by 5 pm**.

## Films to Review

\vspace{0.3cm}

You must review **_two_** movies. 

**Movie #1:** Select any film on this list.

1. ***The African Queen*** (1951): In WWI East Africa, a gin-swilling Canadian riverboat captain is persuaded by a strait-laced English missionary to undertake a trip up a treacherous river and use his boat to attack a German gunship. *(Starring Humphrey Bogart & Katharine Hepburn; Directed by John Huston)*. Rotten Tomatoes: 96%

<!-- ***The Emerald Forest*** (1985): After the son of engineer Bill Markham is abducted by an aboriginal tribe on the edge of the rain forest, the engineer spends the next 10 years searching for him. *(Starring Powers Boothe, Meg Fosterm, Charley Boorman; Directed by John Boorman)*.  -->

1. ***Aguirre, the Wrath of God*** (1972): In the 16th century, the ruthless and insane Don Lope de Aguirre leads a Spanish expedition in search of El Dorado. Noted by legendary film critic Roger Ebert as one of his top ten favorite films of all time - an unforgettable portrait of madness and power. *Starring Klaus Kinski, Ruy Guerra, Helena Rojo; directed by Werner Herzog).* Available free on [Kanopy](https://www.kanopy.com/en/ufl/video/653252) for UF students.  Rotten Tomatoes: 96%

1. ***Apocalypse Now*** (1979): A U.S. Army officer serving in Vietnam is tasked with assassinating a renegade Special Forces Colonel who sees himself as a god. *(Starring Martin Sheen, Marlon Brando, and Robert Duvall; Directed by Francis Ford Coppola)*. Rotten Tomatoes: 96%

1. ***Predator*** (1987): A team of commandos on a mission in a Central American jungle find themselves hunted by an extraterrestrial warrior. *(Starring Arnold Schwarzenegger, Carl Weathers, Kevin Peter Hall; Directed by John McTiernan).*. Rotten Tomatoes: 96%.  

1. ***Avatar*** (2009): A paraplegic Marine dispatched to the moon Pandora on a unique mission becomes torn between following his orders and protecting the world he feels is his home. *Starring Sam Worthington, Zoe Salndaña, and Sigourney Weaver; Directed by James Cameron.* Rotten Tomatoes: 81%

<!-- Dora and the Lost City of Gold (2019). Rotten Tomatoes: 85% -->

**Movie #2:** Select _either_ another movie from the list above OR any movie of your choice from the movie list linked on the course canvas page. To help you decide you can watch the trailers on the Course's Tropical Movie Trailers [YouTube List](https://youtube.com/playlist?list=PL5YVP-qXy1H9hSnUQ6B2VoOfgf16sGHc-&si=qEzL7kXzk7FGaMzx) or by searching for the movie on [IMDB](https://www.imdb.com/) or [YouTube](https://www.youtube.com/).
...
Remember what I said about value judgments? Well...let's just put that aside for a moment to say there are some movies that are so ridiculously bad that I will award 25 points of extra credit for conducting data collection on the tropes in a 3rd movie from the extra-credit section of the movie list. 
...
1.  **Document** the presence of some common tropes about rain forests in each film. To do so, use the *Trope Datasheet* available on the course Canvas page, which lists some common tropes by category (e.g., Plot, Characters, Dialogue, Flora and Fauna). Print a copy of the data sheet for each movie, review the tropes in each category, and then as you watch the movie record which ones you see and record the approximate time of the movie at which they appear for the first time, known as the 'time stamp' (hour & minute, e.g, " 1 H 22 m").   
...
2.  **Reflect** on how the tropes and elements used by the filmakers *reinforced* one or more of the historical themes about rain forests and the people that live in them that we discussed in class, i.e., The Tropics Are:
...
3.  **Summarize** your collective reflections about the two films in 1-2 paragraphs (300-500 words, single space) in which you **(a)** identify the rain forest theme or themes with which each movie aligns, **(b)** provide examples of the tropes and film elements as evidence to support your choice, and **(c)** speculate as to what someone watching this movie with little knowledge of rain forests would conclude about this ecosystem, its biodiversity, and the people living there.
...
2.  Upload a single .pdf or MS Word file of the 1-2 paragraph reflection into Canvas.
