...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, coltitle=black, titlerule=0mm, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Important note regarding class discussions \& group work.}, opacitybacktitle=0.6, opacityback=0, colframe=quarto-callout-tip-color-frame, leftrule=.75mm, arc=.35mm, colback=white, bottomrule=.15mm, rightrule=.15mm, toprule=.15mm, left=2mm, breakable]
...
\addcontentsline{toc}{section}{Week 15 No Class - Thanksgiving Holiday}

\markright{Week 15 No Class - Thanksgiving Holiday}
